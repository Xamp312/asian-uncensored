      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">Edit {{$feedback->name}}'s Feedback</h1>
          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-legendary  border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0 text-white">Edit Feedback</h3>
                </div>
                <div class="col-4 text-right d-none d-md-block d-lg-block">
                  <a href="https://www.amazon.com/sp?_encoding=UTF8&asin=&isAmazonFulfilled=1&isCBA=&marketplaceID=ATVPDKIKX0DER&orderID=&protocol=current&seller=A3RGZ1Z65YEZYY&sshmPath=" target="_blank" class="btn btn-sm btn-primary">Goto Amazon Store</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form method="post" action="{{route('updateFeedback')}}">
                @csrf
                <input type="hidden" value="{{$feedback->id}}" name="id">
                <h6 class="heading-small text-muted mb-4">Customer Feedback</h6>
                <div class="pl-lg-4">
                  <div class="row ">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" name="name" class="form-control form-control-alternative"
                          placeholder="Customer Name" value="{{$feedback->name}}">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <!-- <label class="form-control-label" for="input-username">Username</label> -->
                        <textarea type="text" id="input-username" name="comment" class="form-control form-control-alternative"
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <!-- <label class="form-control-label" for="input-username">Username</label> -->
                        <input type="text" id="input-username" name="product" class="form-control form-control-alternative"
                          placeholder="Product"  value="{{$feedback->product}}" >
                      </div>
                    </div>
