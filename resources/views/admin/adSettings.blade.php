    ...
    <div class="container-fluid d-flex align-items-center">
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <h1 class="display-2 text-white">Ad Settings</h1>
        ...
        <div class="card bg-secondary shadow">
          <div class="card-header bg-legendary  border-0">
            <div class="row align-items-center">
              <div class="col-8 ">
                <h3 class="mb-0 text-white">Website Ad Settings</h3>
              </div>
          ...
          <div class="card-body">
            <form method="post" action="{{route('updateAdSettings')}}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="row ">
                  <div class="col-lg-6">
                    <div class="form-group" style="margin-bottom: 0.5rem;">
                      ...
                      <label class="form-control-label" for="input-username">Website Verification Link</label>
                      <input type="text" id="input-username" name="verification" class="form-control form-control-alternative"
                        placeholder="Website Verification Link" value="{{ $adSettings->verification_script }}" >
                    </div>
           ...
           <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <label class="form-control-label" for="input-username">Pop Under Script Code</label>
                      <textarea type="text" id="input-username" name="popunder" class="form-control form-control-alternative"
                        placeholder="Script Code" style="height: 5rem;">{{ $adSettings->popunder_script }}</textarea>
                    </div>
                  </div>
