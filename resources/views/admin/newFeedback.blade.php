      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">New Customer Feedback</h1>
          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-legendary  border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0 text-white">Add New Feedback</h3>
                </div>
              ...
              <form method="post" action="{{route('createFeedback')}}">
                ...
                <div class="pl-lg-4">
                  <div class="row ">
                    ...
                    <button type="submit" class="btn btn-primary  text-center">Add Feedback</button>
                  </div>
