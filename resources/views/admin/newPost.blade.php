      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">New Facebook Post</h1>
          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-legendary  border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0 text-white">Add New Post</h3>
                </div>
                <div class="col-4 text-right d-none d-md-block d-lg-block">
                  <a href="https://www.facebook.com/flixall" target="_blank" class="btn btn-sm btn-primary">Goto FB Page</a>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form method="post" action="{{route('createPost')}}">
                @csrf
                <h6 class="heading-small text-muted mb-4">Post Embed Source Link</h6>
                <div class="pl-lg-4">
                  <div class="row ">
                    <div class="col-lg-10">
