    ...
    <div class="container-fluid d-flex align-items-center">
      <div class="row">
        <div class="col-lg-12 col-md-12">
          <h1 class="display-2 text-white">Edit Ad</h1>
        ...
        <div class="card bg-secondary shadow">
          <div class="card-header bg-legendary  border-0">
            <div class="row align-items-center">
              <div class="col-8 ">
                <h3 class="mb-0 text-white">Editing Ad</h3>
              </div>
          ...
          <div class="card-body">
            <form method="post" action="{{route('updateAd')}}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="row ">
                  <div class="col-lg-6">
                    <div class="form-group" style="margin-bottom: 0.5rem;">
                      ...
                      <label class="form-control-label" for="input-username">Ad Name</label>
                      <input type="text" id="input-username" name="name" class="form-control form-control-alternative"
                        placeholder="Ad Name" value="{{ $ad->name }}" >
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom: 0.5rem;">
                      ...
                      <label class="form-control-label" for="input-username">Select Place</label>
                      <select  id="input-username" name="place" class="form-control form-control-alternative"
                        placeholder="Ad Name">
                          <option value="sidenav" @if($ad->place == "sidenav") selected @endif >Side Nav</option>
                          <option value="header" @if($ad->place == "header") selected @endif  >Header</option>

                          <option value="footer" @if($ad->place == "footer") selected @endif  >Footer</option>
                    ...
                    <div class="form-group" style="margin-bottom: 0.5rem;">
                      ...
                      <label class="form-control-label" for="input-username">Select Position</label>
                      <select  id="input-username" name="position" class="form-control form-control-alternative"
                        placeholder="Ad Name">
                          <option value="top" @if($ad->place == "top") selected @endif>Top</option>
                          <option value="bottom" @if($ad->place == "bottom") selected @endif>Bottom</option>
                  ...
                  <div class="form-group" style="margin-bottom: 0.5rem;">
                      ...
                      <label class="form-control-label" for="input-username">Screen</label>
                      <select  id="input-username" name="screen" class="form-control form-control-alternative"
                        placeholder="Ad Name">
                          <option value="desktop" @if($ad->place == "desktop") selected @endif>Desktop</option>
                          <option value="mobile" @if($ad->place == "mobile") selected @endif>Mobile</option>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <label class="form-control-label" for="input-username">Script Code</label>
                      <textarea type="text" id="input-username" name="script" class="form-control form-control-alternative"
                        placeholder="Script Code" style="height: 19rem;">{{ $ad->script }}</textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12 text-center" >
                     <br /> 
                    <button type="submit" style="width: 100%;" class="btn btn-primary  text-center">Submit</button>
                  </div>
